	...
	<div class="inside-page-container author-page-container container">
		<div class="single-post-types-tab-col col-xs-12 col-sm-8">
			<ul class="single-post-types-nav-tabs nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#about" aria-controls="about" role="tab" data-toggle="tab"><?php _e('About'); ?></a></li>
				<li role="presentation"><a href="#blog" aria-controls="blog" role="tab" data-toggle="tab"><?php _e('Blog'); ?></a></li>
			</ul>
