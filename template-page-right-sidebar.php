...
<div id="inside-page-content-wrapper" class="page-right-sidebar-content-wrapper-row content-wrapper-row row">
	<?php if ($featImgURL): ?>
	    <div id="inside-page-featured-img-wrapper" class="container">
	        <div class="feat-img-inner-wrapper row">
	            <img src="<?php echo $featImgURL; ?>" alt="<?php the_title_attribute(); ?> Featured Image" class="feat-img">
	            <div class="feat-img-caption-title">
	                <h2><?php the_title(); ?></h2>
	            </div>
	            <?php if (isset($the_excerpt)): ?>
	...
	<div class="inside-page-container page-container container">
		...
		<div class="page-content-col col-xs-12 col-sm-8">
